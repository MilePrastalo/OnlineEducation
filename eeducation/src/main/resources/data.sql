INSERT INTO teacher (id, confirmed, name, user_password, email) VALUES ('100', 1, 'Ucitelj', '$2a$10$PxvKsblywCsPRpmccc2Id.Vf5bMDvXfRMxUhmhhAL1gxXLcWDAhIa', 'teacher@teacher.com');
INSERT INTO school (`id`, `confirmed`, `email`, `name`, `user_password`) VALUES ('101', 1, 'school@school.com', 'awesome school', '$2a$10$PxvKsblywCsPRpmccc2Id.Vf5bMDvXfRMxUhmhhAL1gxXLcWDAhIa');
INSERT INTO student (`id`, `confirmed`, `email`, `name`, `user_password`) VALUES ('102', 1, 'student@student.com', 'student ime', '$2a$10$PxvKsblywCsPRpmccc2Id.Vf5bMDvXfRMxUhmhhAL1gxXLcWDAhIa');
...
INSERT INTO authority (id, name) VALUES ('104', 'STUDENT');
INSERT INTO authority (id, name) VALUES ('105', 'TEACHER');
INSERT INTO authority (id, name) VALUES ('106', 'SCHOOL');

INSERT INTO user_authority_list (user_id, authority_list_id) values (100,105);
INSERT INTO user_authority_list (user_id, authority_list_id) values (101,106);
INSERT INTO user_authority_list (user_id, authority_list_id) values (102,104);

INSERT INTO question (`id`, `name`,`question_points`, `question_type`) VALUES ('100', 'Java je',5, 'MULTIPLE_CHOICE');
INSERT INTO question (`id`, `name`,`question_points`, `question_type`) VALUES ('101', 'Broj deljiv sa 2 je',5, 'CHECKBOXES');
INSERT INTO question (`id`, `name`,`question_points`, `question_type`) VALUES ('102', '2+2=',5, 'SHORT_ANSWER');
INSERT INTO question (`id`, `name`,`question_points`, `question_type`) VALUES ('103', 'Sta je smisao zivota',5, 'PARAGRAPH');
...
INSERT INTO answer (`id`, `answer_text`, `correct`) VALUES ('105', '4', 1);
...
INSERT INTO question_answer (`question_id`, `answer_id`) VALUES ('102', '105');
